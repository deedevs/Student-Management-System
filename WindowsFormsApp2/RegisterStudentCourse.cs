...
{
    public partial class RegisterStudentCourse : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                String query = "INSERT INTO takes (ID, course_id , sec_id, semester, year) VALUES ('" + studentComboBox.Text + "','" + courseComboBox1.Text + "','" + secComboBox2.Text + "','" + semesterComboBox.Text + "','" + yearComboBox4.Text + "') ";
            ...
            catch (Exception)
            {
                ...
                MessageBox.Show("Student Registered to this Course");
            }
