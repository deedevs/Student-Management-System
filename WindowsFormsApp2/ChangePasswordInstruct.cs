...
{
    public partial class ChangePasswordInstruct : Form
    {
        public ChangePasswordInstruct(string Username)
        {
            InitializeComponent();
        ...
        private void txtoldpassword_Leave(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string query = "select * from instructor where name = '" + label4.Text + "' and Password = '" + txtoldpassword.Text + "' ";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            string query = "update instructor set Password =  '" + password + "' where name = '" + label4.Text + "'; ";
            SqlDataAdapter sda = new SqlDataAdapter(query, con);
            DataTable dt = new DataTable();
            sda.Fill(dt);
            sda.SelectCommand.ExecuteNonQuery();
